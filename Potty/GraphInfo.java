...
public class GraphInfo 
{
	...
	static public String [][] paramList = {
		...
		{ "PE2",	"boolean",		"this is PE2 (not FC3)" },
		...
		{ "testcharge", "boolean",	"PE2 uses immutable test charge" },
		{ "CorrectAnswerPopup", "boolean",	"show message when sliders match example values" },
		{ "Distribution", "int",	"Which Distribution to run, if null then a popup menu appears" }
		};
	...
	public void setParameters( Applet apl )
	{
		...
		PE2 = parseBoolean(apl,paramList[4][0],PE2);
		...
		CorrectAnswerPopup = parseBoolean(apl,paramList[10][0],CorrectAnswerPopup);
		Distribution = parseInt(apl,paramList[11][0],Distribution);
	}
