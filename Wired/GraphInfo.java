...
public final class GraphInfo 
{
	...
	// color for variables
	static public final Color VARIABLE_COLOR = new Color(153,51,0);
	...
	static public final String dateInfo = "07.19.1999";
	
	static public final String [][] paramList = {
		{ "ca2",	"boolean",		"this is CA2 (not CA1)" }
		};
	...
	public void setParameters( Applet apl )
	{
		...
		ca2 = parseBoolean(apl,paramList[0][0],ca2);
	}
	...
	static void yell( Object o )
	{
		System.out.println(o.getClass().getName()+".update");
	}
}
